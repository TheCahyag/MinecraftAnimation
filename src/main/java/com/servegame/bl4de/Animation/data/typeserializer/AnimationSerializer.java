...
public class AnimationSerializer implements TypeSerializer<Animation> {
    ...
    public Animation deserialize(TypeToken<?> type, ConfigurationNode value) throws ObjectMappingException {
        if (AnimationPlugin.instance.isDebug()){
            System.out.println("Hello from AnimationSerializer.deserialize");
        }
...
//        // Subspace
//        Location<World> pos1 = value.getNode("pos1").getValue(TypeToken.of(Location.class));
//        Location<World> pos2 = value.getNode("pos2").getValue(TypeToken.of(Location.class));

        //SubSpace3D subSpace3D = new SubSpace3D(pos1, pos2);
    ...
    public void serialize(TypeToken<?> type, Animation obj, ConfigurationNode value) throws ObjectMappingException {
        if (AnimationPlugin.instance.isDebug()){
            System.out.println("Hello from AnimationSerializer.serialize");
        }
        // Essential parts
        ...
        // Still need to save block contents TODO
    }
}
